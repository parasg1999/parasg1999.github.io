...
The reason why this bug was occurring is that the slots are being generated before the schedule is being checked, and the slot end times were not being checked at all.
