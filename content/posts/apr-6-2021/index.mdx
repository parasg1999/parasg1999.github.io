...
##### 11:00
Okay! Been hammering my keyboard, _Googling_ for possible errors, and banging my head on the wall for the last 2 hours only to realize that the Auth token is invalid, and that the server documentation is crap.
My head hurts. 
