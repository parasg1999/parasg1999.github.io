...
> Break? Sleep! *_the drake meme_ 😂🤷‍♂️
...
##### 20:30
Finally done with the [GitHub Profile ReadMe](https://github.com/parasg1999). So what started at the start of the day came to a halt at the end. Talk about things that take up your life! 😛

##### 22:00
Tried the ant problem on codechef. Ffor the first subtast where `number of lanes = 1`. Figured that the answer should be the product of ants on wither side of origin but is showing an error.  
