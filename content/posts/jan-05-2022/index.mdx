...
##### 10:39
Finally set up the development version but another pitfall of using this SSH based environment is that I can't run my Flutter browser here, and ort forwarding is not happening. Now I'll just read the documentation and see what exactly this is, and how to get started.
